  ...
  return (
    <div className="space-y-12">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
        <FormSection title="Loan Information" description="Basic details about your home loan requirement.">
          ...
          <FormField label="Purpose of Loan" error={errors?.loan_type} required>
            <Select
            ...
            >
              ...
              <SelectContent>
                {[
                  { value: 'Home loan construction', label: 'Home loan construction' },
                  { value: 'Loan against property', label: 'Loan against property' },
                  { value: 'Plot / Flat/ Property Purchase loan', label: 'Plot / Flat/ Property Purchase loan' },
                  { value: 'Vacant plot LAP', label: 'Vacant plot LAP' },
                  { value: 'Home loan renovation', label: 'Home loan renovation' },
                ].map((opt) => (
        ...
        <FormSection title="Applicant Details" description="Personal information of the primary applicant.">
            ...
            <FormField label="Add co-applicant details?" error={errors?.have_coapplicant} required>
              ...
              >
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="co_yes" className="cursor-pointer">Yes</Label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="No" id="co_no" />
                  <Label htmlFor="co_no" className="cursor-pointer">No</Label>
                </div>
              </RadioGroup>
            </FormField>
          </div>
